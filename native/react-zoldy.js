...
var RakunSnapshotContext = /*#__PURE__*/React.createContext(mono$2.then());
var RakunRoot = function RakunRoot(props) {
  var contextOld = useContext(RakunSnapshotContext);
  var value = props.value;
  var context = useMemo(function () {
    return contextOld.then(value);
  }, [value, contextOld]);
  return /*#__PURE__*/React.createElement(RakunSnapshotContext.Provider, {
    value: context
  }, props.children);
};
...
var useZoldyValueLoadable = function useZoldyValueLoadable(zoldyValue) {
  var context = useContext(RakunSnapshotContext);
...
var useSetZoldyState = function useSetZoldyState(zoldyState) {
  var context = useContext(RakunSnapshotContext);
  var set = useCallback(function (valOrUpdater) {
...
var ZoldyRoot = function ZoldyRoot(props) {
  ...
  return /*#__PURE__*/React.createElement(RakunRoot, {
    value: context
  }, props.children);
};

export { ZoldyRoot, useResetZoldyState, useSetZoldyState, useZoldyState, useZoldyStateLoadable, useZoldyValue, useZoldyValueLoadable };
